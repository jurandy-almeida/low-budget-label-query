...
if [ ! -d "$rootdir" ]
then
        echo "Please, download the Office-31 dataset from"
        echo "https://drive.google.com/uc?id=0B4IapRTv9pJ1WGZVd1VDMmhwdlE&export=download"
...
do
	run="python -u office-31.py -r $rootdir"
